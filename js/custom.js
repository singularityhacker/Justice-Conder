...
*************************/
  var win = $(window),
      foo = $('#typer');
      foo.typer(['<h2>Software Developer</h2>','<h2>Application Architect</h2>','<h2>Scrum Master</h2>']);      
            win.resize(function(){
...
// $(window).scroll(function() {
// var theta = $(window).scrollTop() / 5 % Math.PI;
// $('#logo_img').css({ transform: 'rotate(' + theta + 'rad)' });
// });
